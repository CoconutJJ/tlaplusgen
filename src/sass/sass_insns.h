...
#define IMAD_HI_U32(dst, src1, src2, src3)                                     \
  dst = (((uint64_t)src1 * src2) + ((uint64_t)dst << 32 | src3)) >> 32

// TODO: FTZ, TRUNC, and NTZ
#define F2I_FTZ_U32_TRUNC_NTZ(dst, src)                                        \
  dst = (uint32_t)NTZf(TRUNCf(FTZf(AS_FLOAT(src))))
...
#define ISETP_GE_OR_D0(dst0, dst1, src1, src2, src3)                           \
  dst0 = ((int32_t)src1 >= (int32_t)src2) || src3

#define ISETP_GT_AND_D0(dst0, dst1, src1, src2, src3)                          \
  dst0 = ((int32_t)src1 > (int32_t)src2) && src3
#define ISETP_GT_AND_D1(dst0, dst1, src1, src2, src3) dst1 = !dst0

#define ISETP_LT_AND_D0(dst0, dst1, src1, src2, src3)                          \
  dst0 = ((int32_t)src1 < (int32_t)src2) && src3
#define ISETP_LT_AND_D1(dst0, dst1, src1, src2, src3) dst1 = !dst0

#define ISETP_GE_AND_D0(dst0, dst1, src1, src2, src3)                          \
  dst0 = ((int32_t)src1 >= (int32_t)src2) && src3
#define ISETP_GE_AND_D1(dst0, dst1, src1, src2, src3) dst1 = !dst0

#define ISETP_GE_U32_AND_D0(dst0, dst1, src1, src2, src3)                      \
  dst0 = (src1 >= src2) && src3
#define ISETP_GE_U32_AND_D1(dst0, dst1, src1, src2, src3) dst1 = !dst0

#define ISETP_GT_U32_AND_D0(dst0, dst1, src1, src2, src3)                      \
  dst0 = (src1 > src2) && src3
#define ISETP_GT_U32_AND_D1(dst0, dst1, src1, src2, src3) dst1 = !dst0

#define ISETP_NE_U32_AND_D0(dst0, dst1, src1, src2, src3)                      \
  dst0 = (src1 != src2) && src3
#define ISETP_NE_U32_AND_D1(dst0, dst1, src1, src2, src3) dst1 = !dst0

#define ISETP_NE_AND_D0(dst0, dst1, src1, src2, src3)                          \
  dst0 = ((int32_t)src1 != (int32_t)src2) && src3
#define ISETP_NE_AND_D1(dst0, dst1, src1, src2, src3) dst1 = !dst0

#define ISETP_EQ_U32_AND_D0(dst0, dst1, src1, src2, src3)                      \
  dst0 = (src1 == src2) && src3
#define ISETP_EQ_U32_AND_D1(dst0, dst1, src1, src2, src3) dst1 = !dst0

#define UISETP_GE_U32_AND_D0(dst0, dst1, src1, src2, src3)                     \
  ISETP_GE_U32_AND_D0(dst0, dst1, src1, src2, src3)
#define UISETP_GE_U32_AND_D1(dst0, dst1, src1, src2, src3)                     \
  ISETP_GE_U32_AND_D1(dst0, dst1, src1, src2, src3)

#define UISETP_GT_U32_AND_D0(dst0, dst1, src1, src2, src3)                     \
  ISETP_GT_U32_AND_D0(dst0, dst1, src1, src2, src3)
#define UISETP_GT_U32_AND_D1(dst0, dst1, src1, src2, src3)                     \
  ISETP_GT_U32_AND_D1(dst0, dst1, src1, src2, src3)

#define UISETP_NE_U32_AND_D0(dst0, dst1, src1, src2, src3)                     \
  ISETP_NE_U32_AND_D0(dst0, dst1, src1, src2, src3)
#define UISETP_NE_U32_AND_D1(dst0, dst1, src1, src2, src3)                     \
  ISETP_NE_U32_AND_D1(dst0, dst1, src1, src2, src3)

#define UISETP_LT_AND_D0(dst0, dst1, src1, src2, src3)                         \
  ISETP_LT_AND_D0(dst0, dst1, src1, src2, src3)
#define UISETP_LT_AND_D1(dst0, dst1, src1, src2, src3)                         \
  ISETP_LT_AND_D1(dst0, dst1, src1, src2, src3)

#define UMOV(dst, src) dst = src
#define UIADD3(dst, src1, src2, src3) dst = src1 + src2 + src3
#define LOP3_LUT(dst, src1, src2, src3, immLut)                                \
  dst = logical_op3(src1, src2, src3, immLut)
#define ULOP3_LUT(dst, src1, src2, src3, immLut)                               \
  dst = logical_op3(src1, src2, src3, immLut)

// pretend PLOP3 is LOP3?
#define PLOP3_LUT(dst1, dst2, src1, src2, src3, immLut, src4)                  \
...
#define rotate_right_64(val, rot)                                              \
  rot == 64 ? val : ((val << (64 - rot)) | (val >> rot))

#define SHF_R_U32_HI(dst, src1, rot, src2)                                     \
  dst = ((rotate_right_64(concat_u32(src2, src1), rot) >> 32) & 0xFFFFFFFFUL)
...
#define LEA_HI(dst, alo, b, ahi, imm_shift)                                    \
  dst = ((concat_u32(ahi, alo) << imm_shift) >> 32) + b
...
// #define LEA_HI_SX32(dst, src, imm1, imm_shift) \
//   LEA_HI(dst, src, imm1, 0, imm_shift)
#define ULEA_HI_SX32(dst, src, imm1, imm_shift)                                \
  LEA_HI_SX32(dst, src, imm1, imm_shift)
#define LEA_HI_SX32(dst, alo, b, imm_shift)                                    \
  dst = LEA_HI(dst, alo, b, (alo >> 31) ? 0xFFFFFFFF : 0, imm_shift)
